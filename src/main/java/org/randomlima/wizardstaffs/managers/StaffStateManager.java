...
//        }
    ...
    public void checkInvAndDelete(Inventory inventory){
        for(ItemStack itemStack : inventory){
            ...
            if(plugin.verifyStaffItem(itemStack) && plugin.getStaffItemID(itemStack).equals(staff.getUUID())) return;
        }
        delete();
...
//        }
    ...
    public void checkItemAndDelete(ItemStack itemStack){
        if(!plugin.verifyStaffItem(itemStack))return;
    ...
    public void checkIfHeld(Player player){
        ...
        if(checkItem(player.getInventory().getItemInMainHand()) && !plugin.verifyStaffItem(player.getInventory().getItemInOffHand())){
            staff.switchStaffState(StaffState.HELD);
            return;
        }
    ...
    public boolean checkItem(ItemStack itemStack){
        ...
        return plugin.verifyStaffItem(itemStack) && plugin.getStaffItemID(itemStack).equals(staff.getUUID());
    }
